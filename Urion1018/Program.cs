...
namespace Urion1018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Saída
            Imprima o valor lido e, em seguida, a quantidade mínima de notas de cada tipo necessárias, conforme o exemplo fornecido. Não esqueça de imprimir o fim de linha 
